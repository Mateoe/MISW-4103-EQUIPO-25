...
async function testVRTEditProfileLocation() {
  console.log("REALIZANDO PRUEBA VRT DE EDITAR La locación DE PERFIL");
  const escenario = "EditProfileLocation";
  ...
  const screenshots = [
    ...
    "07_editProfileLocation.png",
    "08_saveChanges.png",
    "09_editLocationSuccess.png",
    "10_dropdownMenu.png",
    "11_logOut.png",
  ];
...
module.exports = testVRTEditProfileLocation;
